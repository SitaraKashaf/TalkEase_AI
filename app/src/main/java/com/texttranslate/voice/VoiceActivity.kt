...
import com.texttranslate.voice.databinding.ActivityVoiceBinding
import com.texttranslate.voice.interfaces.OnItemClickListener
import com.texttranslate.voice.interfaces.OnTranslationCompleteListener
import com.texttranslate.voice.translateApi.TranslateApi
...
class VoiceActivity : PermissionHelperActivity(), View.OnClickListener, OnItemClickListener {
    ...
    private var mLanguageCodeTo: String? = "ur"
    var IsFrom = true
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding!!.mTxtFromLang.text = "English"
        binding!!.mTxtToLang.text = "Urdu"
    }
    ...
    fun mRecordVoice() {
        ...
        // Use the selected language code for voice recognition
        intent.putExtra(RecognizerIntent.EXTRA_LANGUAGE, mLanguageCodeFrom ?: "en")
